 ...
 */
export class DataGridParams implements TabRequestComponentParams<DataGridParamsDto>, ExecutableTabRequest {
 ...
 */
export class DataGridData implements TabRequestComponentData<DataGridDataDto> {
 ...
 */
export const gridPropsKey = Symbol('gridProps') as InjectionKey<TabComponentProps<DataGridParams, DataGridData>>
/**
