import { Entity, EntityOld } from '@/modules/connection/model/data/Entity'
 ...
 */
export class EntityConverter implements Converter<DriverEntity, EntityOld> {

    /**
     * Converts driver's representation of entity into evitaLab's representation of entity
     */
    convert(driverEntity: DriverEntity): EntityOld {
        return driverEntity
    }
}
