...
export class FacetGroupStatistics {
    ...
    constructor(referenceName: Value<string>, count: Value<number>, facetStatistics: Value<List<FacetStatistics>>, groupEntityReference: Value<EntityReference | undefined>, groupEntity: Value<Entity | undefined>){
