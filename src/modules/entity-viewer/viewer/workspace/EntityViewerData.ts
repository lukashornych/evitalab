 ...
 */
export class EntityViewerData implements TabRequestComponentData<DataGridDataDto> {
    ...
    static restoreFromSerializable(json: TabRequestComponentDataDto): EntityViewerData {
        const dto: DataGridDataDto = json as DataGridDataDto
        return new EntityViewerData(
            dto.queryLanguage,
            dto.filterBy,
            dto.orderBy,
            dto.dataLocale,
