 ...
 */
export class EntityViewerRequest extends TabRequest<DataGridParams, DataGridData> {
    ...
    static createNew(connection: EvitaDBConnection,
                     ...
                     executeOnOpen: boolean = false): EntityViewerRequest {
        return new EntityViewerRequest(
    ...
    static restoreFromJson(labService: LabService, paramsJson: TabRequestComponentParamsDto, dataJson?: TabRequestComponentDataDto): EntityViewerRequest {
