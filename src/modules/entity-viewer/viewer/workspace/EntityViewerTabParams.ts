 ...
 */
export class EntityViewerTabParams implements TabRequestComponentParams<DataGridParamsDto>, ExecutableTabRequest {
    ...
    static restoreFromSerializable(labService: LabService, json: TabRequestComponentParamsDto): EntityViewerTabParams {
