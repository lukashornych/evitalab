 ...
 */
export class SchemaViewerTabParams implements TabRequestComponentParams<SchemaViewerParamsDto> {
    ...
    static restoreFromSerializable(labService: LabService, json: TabRequestComponentParamsDto): SchemaViewerTabParams {
